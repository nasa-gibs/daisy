...
function getGreyLog(val, min, max){
    var colors = [];
...
function getJetScalar(val, min, max){
    var colors = [];
...
function getJetLog(val, min, max){
    var colors = [];
...
function getPanoplyScalar(val, min, max){
    var colors = [];
    var val = (val - min)/(max - min);
    if(val < 1/15){
...
function getPanoplyLog(val, min, max){
    var colors = [];
    var val = Math.log10(((val - min)/(max - min)) * 9 + 1);
    if(val < 1/15){
        var r = (val * 15) * (41 - 25) + 25;
...
function getParulaScalar(val, min, max){
    var colors = [];
    var val = (val - min)/(max - min);
    if(val < 1/15){
...
function getParulaLog(val, min, max){
    var colors = [];
    var val = Math.log10((val - min)/(max - min) * 9 + 1);
    if(val < 0){
        val = 0;
...
function getRedBlueScalar(val, min, max){
    var colors = [];
    var val = (val - min)/(max - min);
    if(val < 1/15){
        var r = (val * 15) * (24 - 8) + 8;
...
function getRedBlueLog(val, min, max){
    var colors = [];
    var val = Math.log10((val - min)/(max - min) * 9 + 1);
    if(val < 1/15){
        var r = (val * 15) * (24 - 8) + 8;
...
function getCubeHelixScalar(val, min, max){
    var colors = [];
    var val = (val - min)/(max - min);
    if(val < 1/15){
        var r = 0;
...
function getCubeHelixLog(val, min, max){
    var colors = [];
    var val = Math.log10((val - min)/(max - min) * 9 + 1);
    if(val < 1/15){
        var r = 0;
...
function getDiverging(val, min, max){
    var colors = [];
    var val = (val - min) / (max - min);
    if(val < 1/10){
